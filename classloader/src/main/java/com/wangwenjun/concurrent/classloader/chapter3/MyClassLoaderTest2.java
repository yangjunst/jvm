...
public class MyClassLoaderTest2 {
    public static void main(String[] args) throws ClassNotFoundException {
        ...
        Class<?> aClass = classLoader1.loadClass("com.wangwenjun.concurrent.classloader.chapter1.MyObject");
        System.out.println(aClass.hashCode());
        Class<?> aClass2 = classLoader2.loadClass("com.wangwenjun.concurrent.classloader.chapter1.MyObject");
